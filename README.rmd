...
We have recently setup an example project so that you can see our package in action! Please visit [dymium-org/dymiumExampleProject](https://github.com/dymium-org/dymiumExampleProject) to learn more about it.
...
- [x] __Version 0.1.0__: (21 Jan 2020) Releases all the basic building blocks for microsimulation modelling.
- [ ] __Version 0.2.0__: Implements model-based calibration.
