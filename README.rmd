...
- If a `data.frame` or `data.table` is provided, it must contain a key column or keys columns and
...
columns which are `probs`, a list column that contains numeric vectors, and `choices`, also 
...
search situation it properly would be inappropiate to assume that all relocating households 
