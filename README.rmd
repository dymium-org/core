...
- [x] __Version 0.1.0__: (21 Jan 2020) Release all the basic building blocks for microsimulation modelling.
  ...
  - [x] __Version 0.1.7__: Introduce simpler APIs (`mutate_entity()`, `add_entity()`, `add_log()`, `transition()`) for creating simple microsimulation pipelines.
  - [ ] __Version 0.1.8__: Support regression model creation from parameters. 
  - [ ] __Version 0.1.9__: Support `mlr3` and `mlogit` model objects in the Transition classes.
  - [ ] __Version 0.1.10__: Support multiple choice models (multinomial logit models (MNL) and MNL with varying alternatives) with utility functions for sampling and simulation. This will be the last milestone for version 0.1.
