test_that("init", {
  Ntwk <- Network$new(toy_network, id_col = "id", from_node = "fnode", to_node = "tnode", dist = "length")
  ...
  expect_error(Network$new(toy_network, id_col = "nb_lanes"))
  expect_error(Network$new(toy_network, id_col = "eid"))
